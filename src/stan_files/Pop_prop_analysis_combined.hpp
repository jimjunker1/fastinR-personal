...
#include <meta_header.hpp>
 class model_Pop_prop_analysis_combined
  : public stan::model::model_base_crtp<model_Pop_prop_analysis_combined> {
private:
        int n_prey_samps;
        int n_prey_samps_SI;
        int n_preys;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int j = 1; j <= n_preys; ++j) {
                ...
                lp_accum__.add(lkj_corr_cholesky_log<propto__>(get_base1(corr_prey, j, "corr_prey", 1), 0.99));
                ...
                lp_accum__.add(lkj_corr_cholesky_log<propto__>(get_base1(corr_prey_SI, j, "corr_prey_SI", 1), 0.99));
            ...
            lp_accum__.add(lkj_corr_cholesky_log<propto__>(corr_pred, 0.99));
            current_statement_begin__ = 160;
            lp_accum__.add(normal_log<propto__>(tau_pred_SI, 0, 10));
            current_statement_begin__ = 161;
            lp_accum__.add(lkj_corr_cholesky_log<propto__>(corr_pred_SI, 0.99));
            current_statement_begin__ = 163;
            lp_accum__.add(normal_log<propto__>(tau_mean, 0, 10));
            current_statement_begin__ = 164;
            lp_accum__.add(lkj_corr_cholesky_log<propto__>(corr_mean, 0.99));
            current_statement_begin__ = 165;
            lp_accum__.add(normal_log<propto__>(tau_mean_SI, 0, 10));
            current_statement_begin__ = 166;
            lp_accum__.add(lkj_corr_cholesky_log<propto__>(corr_mean_SI, 0.99));
